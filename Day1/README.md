...
# Day 1 Assignment 1: SQL Practice
**Date:** Monday, July 13, 2026

This repository contains basic to intermediate SQL practice queries. The exercises cover foundational SQL commands including filtering, aggregations, sorting, and pattern matching.

## 🗄️ Database Setup

The queries are written for the following `Employees` table:
